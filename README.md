...
|-------|----------------------------------------------------|----------------------------------------------------------------------------------|------------------|
| 1     | [Deny Public S3 Buckets](./Policy-As-Code/Lab-1-Deny-Public-S3/README.md) | Use Rego and Conftest to prevent public S3 bucket configs                        | Policy-as-Code   |
| 2     | [Block Open Security Groups](./Policy-As-Code/Lab-2-Block-Open-Security-Groups/README.md) | Detect and block 0.0.0.0/0 open security groups using policy-as-code             | Policy-as-Code   |
| 3     | [Control Mapping for Beginners](./Control-Mapping/Lab-01-Control-Mapping-for-Beginners/README.md) | Learn how to connect NIST 800-53 controls to real DevSecOps tooling              | Control Mapping  |
